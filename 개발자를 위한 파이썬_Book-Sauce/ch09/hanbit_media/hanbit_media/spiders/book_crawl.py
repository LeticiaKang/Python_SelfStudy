...
# scrapy crawl book_crawl -o book_test.xml -t xml
# scrapy crawl book_crawl -o book_test.json -t json
# scrapy crawl book_crawl -o book_test.jl -t jl
# scrapy crawl book_crawl -o book_test.csv -t csv